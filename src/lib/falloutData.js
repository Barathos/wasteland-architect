...
export const CORE_WEAPONS = [
  ...
  { key: '10mm_pistol', label: '10mm Pistol', type: 'Small Guns', damage: '4 CD', damageEffect: '-', damageType: 'Physical', fireRate: 2, range: 'Close', qualities: 'Close Quarters, Reliable', weight: 4, cost: 50, rarity: 1, ammo: '10mm', source: 'Core' },
  ...
  { key: 'pipe_bolt_action', label: 'Pipe Bolt-Action', type: 'Small Guns', damage: '5 CD', damageEffect: 'Piercing 1', damageType: 'Physical', fireRate: 0, range: 'Close', qualities: 'Unreliable', weight: 3, cost: 30, rarity: 0, ammo: '.38', source: 'Core' },
  { key: 'pipe_gun', label: 'Pipe Gun', type: 'Small Guns', damage: '3 CD', damageEffect: '-', damageType: 'Physical', fireRate: 2, range: 'Close', qualities: 'Close Quarters, Unreliable', weight: 2, cost: 30, rarity: 0, ammo: '.38', source: 'Core' },
  ...
  // Energy Weapons
  { key: 'institute_laser', label: 'Institute Laser', type: 'Energy Weapons', damage: '3 CD', damageEffect: 'Burst', damageType: 'Energy', fireRate: 3, range: 'Close', qualities: 'Close Quarters, Inaccurate', weight: 4, cost: 50, rarity: 2, ammo: 'Fusion Cell', source: 'Core' },
  ...
  { key: 'laser_gun', label: 'Laser Gun', type: 'Energy Weapons', damage: '4 CD', damageEffect: 'Piercing 1', damageType: 'Energy', fireRate: 2, range: 'Close', qualities: 'Close Quarters', weight: 4, cost: 69, rarity: 2, ammo: 'Fusion Cell', source: 'Core' },
  { key: 'plasma_gun', label: 'Plasma Gun', type: 'Energy Weapons', damage: '6 CD', damageEffect: '-', damageType: 'Physical/Energy', fireRate: 1, range: 'Close', qualities: 'Close Quarters', weight: 4, cost: 123, rarity: 3, ammo: 'Plasma Cartridge', source: 'Core', note: 'Reduce total by lower resistance.' },
