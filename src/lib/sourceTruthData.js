import {
  ...
  SOURCE_WEAPON_MODS,
  SOURCE_APPAREL_MODS,
  SOURCE_WEAPON_MOD_COMPATIBILITY,
  SOURCE_APPAREL_MOD_COMPATIBILITY,
...
export const CORE_WEAPON_MODS = [...SOURCE_WEAPON_MODS];
export const CORE_APPAREL_MODS = [...SOURCE_APPAREL_MODS];
export const CORE_WEAPON_MOD_COMPATIBILITY = { ...SOURCE_WEAPON_MOD_COMPATIBILITY };
export const CORE_APPAREL_MOD_COMPATIBILITY = { ...SOURCE_APPAREL_MOD_COMPATIBILITY };
